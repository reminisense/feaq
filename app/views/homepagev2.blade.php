...
<head>
  ...
  <title>FeatherQ v6</title>
  <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
  <link rel="icon" href="images/favicon.ico" type="image/x-icon">
  <link rel="stylesheet" type="text/css" href="/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="/css/homepagev2/overrides.css">
    ...
    <body ng-app="FeatherQ" ng-cloak>
        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              <img src="/images/homepagev2/featherq-logo.png" alt="FeatherQ">
            </a>
          </div>
        ...
        <div class="clearfix">
            <div class="col-md-5">
              ...
              <div class="partners">
                ...
                <img src="/images/homepagev2/isuzu.png">
                <img src="/images/homepagev2/grabtaxi.png">
                <img src="/images/homepagev2/honda.png">
              </div>
            </div>
            <div class="col-md-offset-1 col-md-6">
              <div class="holdphone">
                <img src="/images/homepagev2/featherq-app.png">
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="phone ">
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane fade active in" id="signup">
                    <img src="/images/homepagev2/screen1.jpg">
                  </div>
                  <div role="tabpanel" class="tab-pane fade " id="setup">
                    <img src="/images/homepagev2/screen2.jpg">
                  </div>
                  <div role="tabpanel" class="tab-pane fade " id="serve">
                    <img src="/images/homepagev2/screen3.jpg">
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="benefits">
        <div class="container">
          ...
          <div class="row" style="margin-top: 0;">
            ...
            <div class="col-md-4">
              <img class="img-responsive" src="/images/homepagev2/step1.png" alt="Reduce Opportunity Loss" >
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 col-md-offset-1">
              <img class="img-responsive" src="/images/homepagev2/step2.png" alt="Retain Clientele" >
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <img class="img-responsive" src="/images/homepagev2/step3.png" alt="Manage from Anywhere" >
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="features">
        <div class="container text-center">
          ...
          <div class="clearfix">
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-30.png" alt="" />
              <p>30-second <br>Business Setup</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-flexible.png" alt="" />
              <p>Flexible <br>line management</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-customize.png" alt="" />
              <p>Customizable <br>Features</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-business.png" alt="" />
              <p>Business <br>Analytics</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-minimal.png" alt="" />
              <p>Minimal <br>Setup</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-easy.png" alt="" />
              <p>Easy Customer <br>Notifications</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-simple.png" alt="" />
              <p>Simple <br>Interface</p>
            </div>
            <div class="col-md-3">
              <img src="/images/homepagev2/feat-free.png" alt="" />
              <p>It's Free</p>
            </div>
          </div>
        </div>
          ...
          <div class="row imgs">
            <div class="col-md-3">
              <div class="block text-center hos">
                <img src="/images/homepagev2/hospitals.png" alt="Hospitals" />
                <p>Hospitals</p>
              </div>
            </div>
            <div class="col-md-3">
              <div class="block text-center ban">
                <img src="/images/homepagev2/banks.png" alt="Banks" />
                <p>Banks</p>
              </div>
            </div>
            <div class="col-md-3">
              <div class="block text-center sch">
                <img src="/images/homepagev2/schools.png" alt="Schools" />
                <p>Schools</p>
              </div>
            </div>
            <div class="col-md-3">
              <div class="block text-center res">
                <img src="/images/homepagev2/restaurants.png" alt="Restaurants" />
                <p>Restaurants</p>
              </div>
            </div>
          </div>
          <div class="clearfix mt50">
              <div class="col-md-5">
                <div class="block plus">
                  <h2 class="ml20"><img class="pull-left mr20" src="/images/homepagev2/plus.png" alt="plus" />Or any service oriented <br>business process!</h2>
                </div>
              </div>
              <div class="col-md-7">
      ...
      <section class="contactus">
        <div class="container">
          <div class="row">
          <div class="col-md-6">
            <img src="/images/homepagev2/featherq-footer.png" alt="FeatherQ" />
            <h1>A Powerful, <br>
              Free, <br>
      ...
      <script type="text/javascript" src="/js/homepagev2/migrate.min.js"></script>
      <script type="text/javascript" src="/js/homepagev2/slick.min.js"></script>
      <script type="text/javascript" src="/js/bootstrap.min.js"></script>
      <script type="text/javascript" src="/js/homepagev2/ie10-viewport-bug-workaround.js"></script>
      <script type="text/javascript" src="/js/homepagev2/scripts.js"></script>
    </body>
    </html>
