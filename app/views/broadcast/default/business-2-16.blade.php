...
<input type="hidden" value="{{ $groupsToShow[15] }}" ng-model="box16" id="box16">
...
<div class="numbers-area {{ $num_class }} abs">
  <div class="boxed business-spec" id="broadcast-spec">
    ...
    <div class="row services-container eight-rows">
      ...
      <div class="col-md-6 service-box @{{ color15 }}">
        <div class="row title">@{{ service15 }}</div>
        <div class="row number-list">
          <div class="col-md-8 current dark-orange blink-num">@{{ current15 }}
      ...
      <div class="col-md-6 service-box @{{ color16 }}">
        <div class="row title">@{{ service16 }}</div>
        <div class="row number-list">
          <div class="col-md-8 current dark-orange blink-num">@{{ current16 }}
            <p class="terminal">@{{ terminal16 }}</p>
          </div>
          <div class="col-md-4">
            <p>@{{ called16 }}</p>
          </div>
