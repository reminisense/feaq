...
<div class="modal fade" id="moreq" tabindex="-1" ng-controller="issuenumberController">
    <point-of-interest position="left" bottom="84" right="64" title="Issue Specific Number"
                       description="This tab allows you to issue one specific number and input information about the person assigned to the number."></point-of-interest>
    <point-of-interest position="right" bottom="84" right="56" title="Issue Multiple Numbers"
                       description="This tab allows you to issue multiple numbers depending on the range that you provide."></point-of-interest>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul id="pmore-tab" class="nav nav-tabs">
                    <li class="active"><a data-submit="#issue-specific-submit" href="#insertq" data-toggle="tab">INSERT
                            TO QUEUE</a></li>
                    ...
                    <div class="" id="insertq">
                        <form class="navbar-form navbar-left" name="issue_specific_form">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group mb20" style="width: 100%;">
                                        <span class="input-group-addon"
                                              ng-show="number_prefix">@{{ number_prefix }}</span>
                                        <input type="text" min="1" class="form-control" ng-model="priority_number"
                                               name="priority_number">
                                        <span class="input-group-addon"
                                              ng-show="number_suffix">@{{ number_suffix }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label><strong>Time to Call</strong></label>
                                </div>
                                <div class="col-md-9">
                                    <input type="datetime-local" class="form-control" ng-model="time_assigned"
                                           name="time_assigned">
                                    <!--ARA for timebound numbers-->
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-info col-md-12 text-center">
                                        <p>An empty value in the <strong>Specific #</strong> field will automatically
                                            give you the next available number.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="alert alert-warning" role="alert" ng-show="priority_number.length > 3">
                                <div>
                                    <strong class="message">Please make sure that the length of your number will fit the
                                        boxes of your broadcast screen.
                                        <br/>The ideal number of characters that will fit the broadcast screen is 4
                                        characters.
                            ...
                            <div class="alert alert-danger col-md-12" role="alert"
                                 ng-show="issue_specific_error.length > 0">
            ...
            <div class="modal-footer">
                ...
                <button id="issue-multiple-submit" type="button" class="issue-submit-btn btn btn-orange btn-md"
                        ng-disabled="isIssuing" ng-click="checkIssueMultipleErrors()" style="display: none">SUBMIT
                </button>
            </div>
        </div>
    </div>
