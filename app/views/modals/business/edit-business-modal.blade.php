                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" data-toggle="tooltip" data-placement="top" data-original-title="Use arrow keys to select address" class="form-control" id="edit_business_address" ng-autocomplete value="@{{ business_address }}" ng-model="business_address" options="options" details="details">
                                </div>
                                <div class="col-md-12">
