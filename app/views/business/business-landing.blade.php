    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#featherq-works">HOW IT WORKS<span class="sr-only">(current)</span></a></li>
    ...
    <div class="container">
        <div class="col-md-12">
           ...
           -moz-animation-delay: 0.2s; animation-delay: 0.2s;">
                            ...
                            <h1>FeatherQ is a cloud-based queuing platform. We make it easy for businesses to <span>manage their lines better</span> and allow customers to wait on their own terms.</h1>
                        </div>
                        <div class="clearfix">
                            <p id="start">Start using FeatherQ</p>
                            <a href="#contact-us" class="btn btn-blue">CONTACT US TO SIGN UP!</a>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 visible-sm visible-xs">
                        <img class="img-responsive" style="margin: auto;" src="/images/business/landing/featherq-on-mobile-sm.png" alt="FeatherQ on mobile" />
    ...
    <div class="container">
        ...
        <div class="clearfix">
            <div class="col-md-4 text-center">
                <img style="width:180px;" src="/images/business/landing/reduce.png" alt="Manange from anywhere" />
                <h4 class="orange">Reduce Opportunity Loss</h4>
                <p>Your customers can line up for your business using their cellphone, reducing line that turn customers away.</p>
            </div>
            <div class="col-md-4 text-center">
                <img style="width:180px;" src="/images/business/landing/retain.png" alt="Manange from anywhere" />
                <h4 class="orange">Retain Clientele</h4>
                <p>Build goodwill and transparency by communicating quickly and effectively with waiting guests.</p>
            </div>
            <div class="col-md-4 text-center">
                <img style="width:180px;" src="/images/business/landing/anywhere.png" alt="Manange from anywhere" />
...
<section id="featherq-works" ng-controller="demoController">
    <div class="container">
        <div class="tri text-center">
            <img style="width: inherit" src="/images/business/landing/tri-contact.png">
        </div>
        <div class="clearfix">
            <div class="col-md-12">
                <h2 class="text-center">Try out the FeatherQ Process today!</h2>
            </div>
        </div>
        <div class="clearfix">
            <div class="col-md-3 text-center">
                <div id="app" class="center">
                    <div class="clearfix boxes">
                        <div class="box-left pull-left @{{ boxes.box1.box_class }}">
                            <p>
                                <span>@{{ boxes.box1.terminal }}</span>
                                @{{ boxes.box1.number }}
                            </p>
                        </div>
                        <div class="box-right pull-right @{{ boxes.box2.box_class }}">
                            <p>
                                <span>@{{ boxes.box2.terminal }}</span>
                                @{{ boxes.box2.number }}
                            </p>
                        </div>
                        <div class="box-left pull-left @{{ boxes.box3.box_class }}">
                            <p>
                                <span>@{{ boxes.box3.terminal }}</span>
                                @{{ boxes.box3.number }}
                            </p>
                        </div>
                        <div class="box-right pull-right @{{ boxes.box4.box_class }}">
                            <p>
                                <span>@{{ boxes.box4.terminal }}</span>
                                @{{ boxes.box4.number }}
                            </p>
                        </div>
                    </div>
                    <div class="remoteq clearfix">
                        <div class="pull-left">
                            <p>Remote <br>Queue</p>
                        </div>
                        <div class="pull-right">
                            <h3 style="width: 68px; overflow: hidden;">@{{  data.issue_number }}</h3>
                        </div>
                        <div class="clearfix">
                            <a href="" class="btn btn-xs btn-orange" ng-click="getNumber(data.issue_number)">GET NUMBER</a>
                        </div>
                    </div>
                </div>
                <h4 class="orange">App User</h4>
                <p>Customers and guests can get a place in line using our FeatherQ mobile app by clicking Get Number.</p>
            </div>
            <div class="col-md-5 text-center">
                <div id="terminal">
                    <table class="table table-striped">
                        <tr>
                            <td>
                                <input type="number" pattern="\d*" maxlength="4" value="" ng-model="data.issue_number" ng-if="data.issued_numbers.length == 0">
                                <select ng-if="data.issued_numbers.length != 0" ng-model="data.selected_number"><option ng-repeat="number in data.issued_numbers" value="@{{ number }}">@{{ number }}</option></select>
                            </td>
                            <td>
                                <a href="" class="btn btn-xs btn-primary" ng-click="getNumber(data.issue_number)">+</a>
                            </td>
                            <td>
                                <a href="" ng-if="data.issued_numbers.length == 0" class="btn btn-xs btn-orange hidden-xs" ng-click="callNumber('TERMINAL 1', data.issue_number, '')">CALL NUMBER</a>
                                <a href="" ng-if="data.issued_numbers.length == 0" class="btn btn-xs btn-orange visible-xs" ng-click="callNumber('TERMINAL 1', data.issue_number, '')">CALL</a>
                                <a href="" ng-if="data.issued_numbers.length != 0" class="btn btn-xs btn-orange hidden-xs" ng-click="callNumber('TERMINAL 1', data.selected_number, '')">CALL NUMBER</a>
                                <a href="" ng-if="data.issued_numbers.length != 0" class="btn btn-xs btn-orange visible-xs" ng-click="callNumber('TERMINAL 1', data.selected_number, '')">CALL</a>
                            </td>
                            <td>
                                <a href="" class="btn btn-xs btn-red" ng-click="stop()">STOP</a>
                            </td>
                        </tr>
                        <tr ng-repeat="box in boxes" ng-if="box.number != ''">
                            <td>
                                @{{ box.number }}
                            </td>
                            <td>
                            ...
                            <td class="text-right">
                                <a href="" class="btn btn-xs" ng-click="drop($index + 1)"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>
                            <td>
                                <a href="" ng-if="data.issued_numbers.length == 0" class="btn btn-xs btn-default" ng-click="next(box.number, 'TERMINAL 1', data.issue_number, '')">NEXT</a>
                                <a href="" ng-if="data.issued_numbers.length != 0" class="btn btn-xs btn-default" ng-click="next(box.number, 'TERMINAL 1', data.selected_number, '')">NEXT</a>
                            </td>
                        </tr>
                    </table>
                </div>
                <h4 class="orange">Business Terminal</h4>
                <p>Call out and serve priority numbers using our FeatherQ web service. You can access this on any internet browser.</p>
            </div>
            <div class="col-md-4 text-center">
                <div id="broadcast">
                    <div class="clearfix boxes">
                ...
                <h4 class="orange">Broadcast Screen</h4>
                <p>Numbers and updates go live in real-time on our FeatherQ Broadcast page. For extra convenience, updates also appear on our mobile application.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="featherq-features">
    <div class="container">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 text-center wow fadeInUp">
            <div class="rel detail-wrap">
                <img class="img-responsive" src="/images/business/landing/features-minimal.png" alt="Cross-platform solution" />
                <h4>Cross-platform<br>solution</h4>
                <div class="abs details">
                    <div class="wrap">
                        <p>FeatherQ's browser-based solution works on any smartphone, tablet or computer.</p>
                    </div>
