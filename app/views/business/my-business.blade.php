            ...
            <form>
                <div class="form-group row">
                    <ul id="bizTab" class="nav nav-tabs" role="tablist">
                        ...
                        <li class=""><a ng-click="currentActiveBroadcastDetails(business_id)" href="#broadcast" id="broadcast-tab" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span> Layouts & Advertisements</a></li>
