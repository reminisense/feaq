...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='css/homepage/onepage-scroll.css'>
  ...
  <script type="text/javascript" src="js/homepage/jquery.onepage-scroll.js"></script>
...
<body ng-app="FeatherQ">
  ...
  <div class="wrapper">
    <div class="main">
          ...
          <div class="container">
                ...
                <div class="col-md-8 col-md-offset-2 col-sm-12">
                  <div class="filterwrap">
                    <div class="btn-group" role="group">
                      ...
                      <div class="btn-group" role="group">
                        <button id="btnTimeOpen" type="button" class="btn btn-default">
                          Time Open
                        </button>
                        <input type="text" id="time_open-filter" name="time_open" placeholder="8:00 AM" class="timepicker form-control" style="width: 145px; display: none;"/>
                      </div>
                    </div>
            ...
            <!-- <div class="row navs">
              <div class="col-md-8 col-md-offset-2 col-xs-12 text-center">
                ...
                <a class="btn-orange">Sign-up Today! <span class="glyphicon glyphicon-menu-down"></span></a>
              </div>
            </div> -->
      ...
      <section class="page2">
        <div class="container">
          <h2 class="orange">FeatherQ Features</h2>
          <div class="row">
          ...
          <div class="container">
            <div class="col-md-12">
              <div class="wrap text-center" ng-controller="fbController">
                <h1>SIGN UP TODAY</h1>
                <p>Its Fast, Its Easy, Its Free</p>
