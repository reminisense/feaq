...
<div id="main_dashboard_container" ng-controller="searchBusinessCtrl">
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="clearfix">
                    ...
                    <point-of-interest position="right" title="Search Businesses" description="Search for the businesses you want to be shown below. You can type in the name of the business or its address."></point-of-interest>
                </div>
            </div>
        </div>
        <div class="arrow">
    ...
    <div class="col-md-12 page-header">
        ...
        <point-of-interest position="right" title="Queueing Businesses" description="Click on any of the businesses below to see what's happening in their broadcast screen."></point-of-interest>
