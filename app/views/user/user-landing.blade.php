...
<section id="wait">
    <div class="container">
        <div class="col-md-12">
            <h2 class="text-center">Wait on your own terms</h2>
        </div>
        <div class="col-md-4 col-sm-4 text-center">
            <img class="wow fadeInUp img-responsive" src="/images/homepage/landing/wait1.png" alt="Join the line from anywhere" />
        ...
        <div class="col-md-4 col-sm-4 text-center">
            <img class="wow fadeInUp" src="/images/homepage/landing/wait2.png" alt="Freedom away from the line." />
        ...
        <div class="col-md-4 col-sm-4 text-center">
            <img class="wow fadeInUp" src="/images/homepage/landing/wait3.png" alt="Share your experience." />
...
<section id="featherq-features">
    <div class="container">
        ...
        <div class="col-md-6 col-sm-6 text-center">
            <img class="wow fadeInUp img-responsive" src="/images/homepage/landing/feature3.png" alt="Join the line from anywhere" />
            <p>Our geo-locator will help you find the nearest businesses. <br>FeatherQ lets you see the status of their lines.</p>
        </div>
        <div class="col-md-6 col-sm-6 text-center">
            <img class="wow fadeInUp img-responsive" src="/images/homepage/landing/feature2.png" alt="Join the line from anywhere" />
        ...
        <div class="col-md-6 col-sm-6 text-center">
            <img class="wow fadeInUp img-responsive" src="/images/homepage/landing/feature1.png" alt="Join the line from anywhere" />
            <p>Receive push notifications on our mobile app<br> whenever your turn is up.</p>
        </div>
        <div class="col-md-6 col-sm-6 text-center">
            <img class="wow fadeInUp img-responsive" src="/images/homepage/landing/feature4.png" alt="Join the line from anywhere" />
...
<section id="beat" ng-controller="fbController">
    <div class="container text-center">
        <div class="col-md-12">
            <h2 class="text-center">Beat the waiting game</h2>
        </div>
