        ...
        <div class="biz-details-wrap">
            <div id="tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#feathercash" data-toggle="tab">FeatherCash</a></li>
                </ul>
            </div>
            <div class="clearfix tab-content">
                ...
                <div class="tab-pane fade in" id="feathercash"> <!--featherqash tab-->
                    @include('admin.admin-tabs.feathercash-tab')
                </div> <!--eo feathercash tab-->
            </div>
        </div>
    </div>
</div>
