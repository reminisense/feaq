...
<section class="page2">
    <div class="container">
        <h1 class="orange wow fadeInUp">Check Our Guides For Setting Up</h1>
        <!-- Start of excerpt 01-->
        <div class="col-md-10 col-xs-10">
            <div class="wrap">
                <a href="{{ URL::to('/how-to/small-restaurants')}}"><h2 class="wow fadeInUp text-left">Small Restaurants &raquo;</h2></a>
            </div>
        </div>
        ...
        <div class="col-md-8 col-xs-8">
            <div class="wrap">
                For Small, Independent, Food & Beverage establishments
                <br /><br />
            </div>
        </div>
        <!-- End of excerpt 01-->
        ...
        <div class="col-md-10 col-xs-10">
            <div class="wrap">
                <a href="{{ URL::to('/how-to/use-qr-code')}}"><h2 class="wow fadeInUp text-left">Use a QR Code &raquo;</h2></a>
            </div>
        </div>
        <div class="col-md-2 col-xs-2">
            <div class="wrap">
        ...
        <div class="col-md-8 col-xs-8">
            <div class="wrap">
                For Small, Independent establishments. Working with Tablets/Phones Only
                <br /><br />
            </div>
        </div>
        <!-- End of excerpt 02-->
        ...
        <div class="col-md-10 col-xs-10">
            <div class="wrap">
                <a href="{{ URL::to('/how-to/call-serve-next')}}"><h2 class="wow fadeInUp text-left">Understanding The Buttons - Call, Next, & Serve &raquo;</h2></a>
            </div>
        </div>
        <div class="col-md-2 col-xs-2">
            <div class="wrap">
