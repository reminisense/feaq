    ...
    public function getUserDashboard(
      ...
      $templateId16 = null
        ...
        if (!empty($raw_code)) {
            ...
            return $broadcast->viewBroadcastPage(
              $raw_code,
              $templateId1,
              $templateId2,
              $templateId3,
...
//    }
    ...
    public function getEmailsearch($email)
    {
        ...
        return $user
          ? json_encode(['success' => 1, 'user' => $user])
          : json_encode([
            'success' => 0,
            'error'   => 'User does not exist in FeatherQ.'
          ]);
    }
    ...
    public function postEmailRegistration()
    {
        ...
        if (
          isset($email) && $email != "" && isset($password) && $password != "" && isset($password_confirm)
          && $password_confirm != ""
        ) {
    ...
    public function postEmailLogin()
    {
        ...
        if (isset($email) && $email != "" && isset($password) && $password != "") {
            ...
            if ($user && !$user->verified) {
                ...
                if ($user && $user->password == '' && $user->fb_id != '') {
...
//    }
    ...
    public function postSendReset()
    {
        ...
        if ($user) {
            ...
            $message = 'You are not yet registered to FeatherQ. To register, click this <a href="' . $url
              . '">link</a>.';
        }
