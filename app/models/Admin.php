...
class Admin extends Eloquent{
    ...
    public static function addAdmin($email){
        try{
            ...
            Helper::dbLogger('Admin', 'CSV', 'insert', 'addAdmin', User::email(Helper::userId()), 'email:' . $email);
            return true;
        }catch(Exception $e){
            return false;
        }
    ...
    public static function removeAdmin($email){
        try{
          ...
          Helper::dbLogger('Admin', 'CSV', 'delete', 'removeAdmin', User::email(Helper::userId()), 'email:' . $email);
            return true;
        }catch(Exception $e){
            return false;
        }
