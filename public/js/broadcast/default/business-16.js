...
app.controller('nowServingCtrl', function ($scope, $http)
{
    ...
    $scope.updateBroadcastPage = (function (response)
    {
        ...
        writeNumberToBoxes($scope, response, 'box13', 'service13', 'current13', 'terminal13', 'color13', 'called13');
        writeNumberToBoxes($scope, response, 'box14', 'service14', 'current14', 'terminal14', 'color14', 'called14');
        writeNumberToBoxes($scope, response, 'box15', 'service15', 'current15', 'terminal15', 'color15', 'called15');
        writeNumberToBoxes($scope, response, 'box16', 'service16', 'current16', 'terminal16', 'color16', 'called16');
